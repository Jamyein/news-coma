...
4. **详细摘要**：严格按照4句话结构生成，必须包含具体事实和数据：
...
5. **关键要点提取**：生成3-5条核心要点，每条必须满足以下要求：
   
   【三条原则】
   1. 具体性原则：每条要点必须包含至少1个具体数字或百分比
   2. 结构完整性：每条要点包含主体、动作、结果三个要素
   3. 信息密度：信息丰富，避免评价性语言
   
   【好的要点示例】
   ✅ "亚马逊、谷歌、微软、Meta四大科技公司2026年计划投入6500亿美元发展AI技术"
   ✅ "6500亿美元相当于美国GDP的2.5%，规模与曼哈顿计划等国家级项目相当"
   ✅ "分析师警告：若AI投资回报不及预期，可能引发科技股估值大规模调整"
   
   【差的要点示例】
   ❌ "大科技公司6500亿美元支出" → 缺少具体公司和上下文
   ❌ "市场不满" → 过于空洞，缺少具体事实
...
{{
  ...
  "key_points": [
    "要点1：包含具体数字和主体动作结果（15-30字）",
    "要点2：包含具体数字和因果分析（15-30字）",
    "要点3：信息密度高，避免空洞评价（15-30字）"
  ]
}}
